...
export const FocusAreas: React.FC<FocusAreasProps> = ({ onLearnMoreAI, onLearnMoreCloud }) => {
  ...
  return (
    <section id="focus-areas" className="py-16 sm:py-24 bg-[#07090e] text-slate-100 border-b border-slate-800 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12 sm:space-y-24">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-10 items-center">
          ...
          <div className="lg:col-span-6">
            <div className="bg-slate-900/90 rounded-2xl border border-slate-800 p-4 sm:p-8 space-y-4 sm:space-y-5 shadow-xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-10 items-center pt-8 border-t border-slate-800/80">
          <div className="lg:col-span-6 lg:order-2 space-y-4 sm:space-y-6">
