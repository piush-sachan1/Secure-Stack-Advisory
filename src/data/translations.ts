...
export const TRANSLATIONS: Record<SupportedLanguage, TranslationDictionary> = {
  en: {
    ...
    sections: {
      ...
      whyUsTitle: 'Why Technical Teams Trust Vectorbound',
  ...
  de: {
    ...
    sections: {
      ...
      whyUsTitle: 'Warum führende Tech-Unternehmen Vectorbound vertrauen',
    ...
    chatbot: {
      welcome: "Willkommen bei Vectorbound. Ich bin Ihr Lead Cloud- & Sicherheitsberater. Stellen Sie mir Fragen zu Multi-Cloud-Architekturen (AWS, GCP, Azure), 24/7 SRE-Betrieb, GitOps-Bereitstellungspipelines, FinOps-Kostenoptimierung oder KI-Bedrohungsmodellen (BSI C5 & NIS-2). Gestützt durch Google-Suche in Echtzeit.",
  ...
  fr: {
    ...
    sections: {
      ...
      whyUsTitle: 'Pourquoi les Équipes Techniques Choisissent Vectorbound',
    ...
    chatbot: {
      welcome: "Bienvenue sur Vectorbound. Je suis votre Ingénieur Principal Conseil Cloud & Cybersécurité. Posez-moi vos questions sur les architectures multi-cloud (AWS, GCP, Azure), les opérations SRE 24/7, l'intégration GitOps, l'optimisation FinOps ou les audits de sécurité IA (SecNum & NIS-2). Réponses appuyées par la recherche Google en temps réel.",
